...
public class RootConfig {
    ...
    @Bean
    public BraintreeGateway braintreeGateway(@Value("jcfy2n6wffwnnqrb") String merchantId,
                                             @Value("44m26tpq76tywdrj") String publicKey,
                                             @Value("279cf365ecbc38d85b90f881c91b3c39") String privateKey) {
